...
<div class="row justify-content-center">
    <div class="col-sm-2 text-center my-3 py-3">
        ...
        <h4 class="text-muted">Categorías</h4>
            ...
            <a class="nav-link category_item border-top" style="color: #873e23;" href="#" category="cerv_combos">SixPacks</span></a>
            </nav>
        </div>
    </div>
                            ...
                            <div class="card align-items-center product-item my-2 mx-2" category="cerv_alemanas" style="width: 15rem;">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    if ($this->session->userdata('login')) {
                                        ...
                                        echo form_submit('comprar', 'Agregar al carrito', "class = 'btn btn-outline-primary'");
                                        echo form_close();
                                    } ?>
                                </div>
                            </div>
