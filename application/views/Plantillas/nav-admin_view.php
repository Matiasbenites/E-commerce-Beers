<header class="hero">
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse justify-content-center navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
      <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('indexAdmin'); ?>">Inicio<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('ver_ventas'); ?>">Ventas<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('Agregar'); ?>">Agregar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('gestionar'); ?>">Gestionar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('catalogo/2'); ?>">Catálogo</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('listar_mensajes'); ?>">Ver Consultas</a>
        </li>
